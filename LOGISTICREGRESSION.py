...
model = LogisticRegression(penalty='elasticnet', solver='saga', l1_ratio=0., random_state=42, max_iter=1000)
...
results_df = pd.DataFrame({
    "bill_id": test_ids,
    "LogReg_Probability": prob_class2
})
results_df.to_csv("predictions_lr.csv", index=False)
print("\nPredictions saved to 'predictions_lr.csv'.")
